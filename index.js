...
client.once("ready", () => {
  clanTracker.startClanTracker(client, config, tools.coc, tools.data);
});
...
const welcomeManager = require("./utils/welcomeManager.js");
welcomeManager.startWelcomeManager(client, tools);
