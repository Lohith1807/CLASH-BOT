    ...
    getEmbed: (emojis = {}) => {
        return new EmbedBuilder()
            ...
            .setDescription(
                ...
                `${getEmoji('parrow')} **7. Where you found Blood Alliance –**\n` +
